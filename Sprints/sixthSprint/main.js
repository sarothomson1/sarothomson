...
var butOne = new Button("Rectangle", 55, 40, 120, 50, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
var butTwo = new Button("Ellipse", 55, 110, 120, 50, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
var butThree = new Button("Circle", 55, 180, 120, 50, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
...
objectSet.push(reset, undo, butOne, butTwo, butThree, cButOne, cButTwo, cButThree, cButFour, cButFive, cButSix,
