...
class controlobject {
    ...
    if(this.dragging){
        //sets radius of brush circle to 10 pixels
        this.r = 10;
        //to draw individual circles tracking movement of mouse to create brush line
        if(Button.selectedShape == "Brush"){
            //parameters for circles of brush line
        ...
        //if(this.mouseDown == true && this.rectBound == true){
            ...
            }else if (Button.selectedShape == "Brush"){
        ...
        //draws the line that is dragged
        drawLine(x,y,w,h){
            ctx.beginPath();
            ctx.moveTo(x,y);
            ctx.lineTo(w,h);
        ...
        //draws the brush path that is dragged
        drawBrush(x,y,r){
            ctx.beginPath();
            ctx.arc(x,y,r,0, 2*Math.PI);
            lineWidth = 10;
